        ...
        <section id="modalDescription" class="modal-body">
          <slot name="body">
            <v-col cols="12" class="text-section">
              <p>Are you sure you want to cancel your payment plan?</p>
            </v-col>
            <v-col cols="12" class="text-section">
              <p>
                You'll still have access until the end of this calendar month,
                after which we'll send you a final invoice and begin rejecting your API requests.
              </p>
            </v-col>
