  ...
  <v-container>
    ...
    <v-row>
      <v-col cols="8" class="form1">
        <h3>Company Name</h3>
        <p>If specified, this name will appear on invoices instead of your organization name.</p>
      ...
      <v-col cols="8" class="form1">
        <h3>Billing email</h3>
        <p>
          Invoices and other billing notifications will be sent here (in addition to being sent to the owners of your
          organization).
        </p>
        <input type="form" placeholder="" class="form_input" />
      </v-col>
