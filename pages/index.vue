    ...
    <div>
        ...
        <div class="feature-boxes">
          <div class="feature-box">
            ...
            <p>
              ...
              realistic dialogues, enhancing the emotional depth and knowledge
              of game events of your characters.
            </p>
          </div>
          <div class="feature-box">
            ...
            <p>
              ...
              interact with players. Make chat GPT a friend or a foe in your
              game quests.
            </p>
          </div>
          <div class="feature-box">
            ...
            <p>
              DialogCraftGPT plugin requires no programming experience to setup
              and use from within your favourite game engine.
            </p>
          </div>
          <div class="feature-box">
            <h3>Secure and Private</h3>
            <p>
              Rest assured that your sensitive game content and storylines are
              safeguarded. We follow strict privacy standards to protect your
      ...
      <section class="get-started">
        ...
        <div class="started-grid">
          <ol class="how-to-start">
            ...
            <li>
              Integrate the generated dialogues into your game seamlessly.
            </li>
          </ol>
      ...
      <section>
        <div class="start-trial">
          <h2 class="page-headers">
            Are you ready to take your game development to the next level with
            the ultimate AI-Powered character building tool?
          </h2>
          <br />
          <button class="button">Start Free Trial Now</button>
        </div>
